...
public class XsltIntegrationTest {
  ...
  public void testEAVOutputPatientAndDiagnosis() throws Exception {
    ...
    try (InputStream in = Files.newInputStream(outputFile.toPath())) {
      ...
      NodeList birthDates =
          doc.getElementsByTagNameNS("http://sekmi.de/histream/ns/eav-data", "birthdate");
      ...
      NodeList encounters =
          doc.getElementsByTagNameNS("http://sekmi.de/histream/ns/eav-data", "encounter");
      assertTrue(encounters.getLength() > 0);
      Element encounter = (Element) encounters.item(0);
      NodeList starts =
          encounter.getElementsByTagNameNS("http://sekmi.de/histream/ns/eav-data", "start");
      ...
      NodeList facts =
          encounter.getElementsByTagNameNS("http://sekmi.de/histream/ns/eav-data", "fact");
