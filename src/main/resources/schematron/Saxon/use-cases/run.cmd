...
rem    for example:
rem    set CP=-cp c:\saxon\saxon9he.jar
...
%JAVA% %CP% net.sf.saxon.Query -t -s:xmp/books.xml -q:xmp/addq6.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:xmp/books.xml -strip -q:xmp/addq6.xq
...
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q1.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q2.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q3.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q4.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q5.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q6.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q7.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q8a.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q8b.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q9.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:sgml/report.xml -q:sgml/q10.xq

%JAVA% %CP% net.sf.saxon.Query -t -s:string/news.xml -q:string/q1.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:string/news.xml -q:string/q2.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:string/news.xml -q:string/q4.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:string/news.xml -q:string/q5.xq

%JAVA% %CP% net.sf.saxon.Query -t -s:ns/auction.xml -q:ns/q1.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:ns/auction.xml -q:ns/q2.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:ns/auction.xml -q:ns/q3.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:ns/auction.xml -q:ns/q4.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:ns/auction.xml -q:ns/q5.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:ns/auction.xml -q:ns/q6.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:ns/auction.xml -q:ns/q7.xq
%JAVA% %CP% net.sf.saxon.Query -t -s:ns/auction.xml -q:ns/q8.xq

%JAVA% %CP% net.sf.saxon.Query -t -s:ns/auction.xml -q:ns/addq1.xq
